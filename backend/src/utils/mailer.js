 ...
 * @param {string} codigo       - Código (PIN) de 6 dígitos
 */
            ...
            <table width="520" cellpadding="0" cellspacing="0"
              ...
              <tr>
                <td style="padding:32px;">
                  ...
                  <!-- Credenciais -->
                  <div style="background:#0f172a;border:1px solid #334155;border-radius:12px;padding:20px;margin-bottom:24px;text-align:center;">
                    <p style="margin:0 0 12px;color:#64748b;font-size:12px;text-transform:uppercase;
                               letter-spacing:0.8px;font-weight:600;">
                      Seu Código
                    </p>
                    <div style="color:#60a5fa;font-size:32px;letter-spacing:8px;font-weight:800;font-family:monospace;padding:10px 0;">
                      ${codigo}
                    </div>
                  </div>
